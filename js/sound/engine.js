...
/* globals webkitOfflineAudioContext */
...
original by kittykatattack@github

*/

function patchAudioContext (global) {
  'use strict';
...
SoundEngine.prototype.makeSound = function (source, loadHandler, loadSound, xhr) {
...
SoundEngine.prototype.loadSound = function (o, source, loadHandler) {
  ...
  xhr.addEventListener("load", this.decodeAudio.bind(this, o, xhr, loadHandler));
...
SoundEngine.prototype.decodeAudio = function(o, xhr, loadHandler) {
...
SoundEngine.prototype.soundEffect = function(
  ...
  function addReverb(volumeNode) {
    ...
    convolver.buffer = engine.impulseResponse(reverb[0], reverb[1], reverb[2], actx);
...
SoundEngine.prototype.impulseResponse = function(duration, decay, reverse, actx) {

  //The length of the buffer.
  var length = this.actx.sampleRate * duration;

  //Create an audio buffer (an empty sound container) to store the reverb effect.
  var impulse = this.actx.createBuffer(2, length, this.actx.sampleRate);
